...
def test_get_dotted_cog_path():
    ...
    options_watcher = Watcher(c, cogs_path='example_bot/commands')
    ...
    deep_nested_path = options_watcher.get_dotted_cog_path('E:\\Examples\\example_bot\\example_bot\\even\\deeper\\commands\\cmd.py')
    posix_deep_nested_path = options_watcher.get_dotted_cog_path('/usr/example_bot/example_bot/even/deeper/commands/cmd.py')
